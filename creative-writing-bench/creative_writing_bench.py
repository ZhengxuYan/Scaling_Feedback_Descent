...
# creative_writing_bench.py
with open("debug_log.txt", "w") as f: f.write("DEBUG: Script started\n")
...
with open("debug_log.txt", "a") as f: f.write("DEBUG: Imports done\n")
...
def main():
    with open("debug_log.txt", "a") as f: f.write("DEBUG: main started\n")
